    ...
    public class CarConfiguration : IEntityTypeConfiguration<Car>
    {
        public void Configure(EntityTypeBuilder<Car> builder)
        {
            ...
            builder.HasData(
                ...
                //SUPER CARS
                new Car() { CarId = 1, ImgPath = "/img/Super/Adder.png", Name = "Adder", Price = 435000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 2, ImgPath = "/img/Super/Bullet.png", Name = "Bullet", Price = 175000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 3, ImgPath = "/img/Super/Cheetah.png", Name = "Cheetah", Price = 300000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 4, ImgPath = "/img/Super/EntityXF.png", Name = "Entity XF", Price = 375000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 5, ImgPath = "/img/Super/Infernus.png", Name = "Infernus", Price = 175000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 6, ImgPath = "/img/Super/Osiris.png", Name = "Osiris", Price = 350000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 7, ImgPath = "/img/Super/T20.png", Name = "T20", Price = 400000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 8, ImgPath = "/img/Super/TurismoR.png", Name = "Turismo R", Price = 300000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 9, ImgPath = "/img/Super/Vacca.png", Name = "Vacca", Price = 125000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 10, ImgPath = "/img/Super/Voltic.png", Name = "Voltic", Price = 175000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 11, ImgPath = "/img/Super/Zentorno.png", Name = "Zentorno", Price = 300000, MSRP = 0, Type = "Super" },

                new Car() { CarId = 189, ImgPath = "/img/Super/Banshee900R.png", Name = "Banshee 900R Bravado", Price = 160000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 190, ImgPath = "/img/Super/Autarch.png", Name = "Autarch", Price = 475000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 191, ImgPath = "/img/Super/EntityXXR.png", Name = "Entity XXR", Price = 450000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 192, ImgPath = "/img/Super/Cyclone.png", Name = "Cyclone Coil", Price = 375000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 193, ImgPath = "/img/Super/Deveste.png", Name = "Deveste Eight Principe", Price = 1500000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 194, ImgPath = "/img/Super/Emerus.png", Name = "Progen Emerus", Price = 500000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 195, ImgPath = "/img/Super/FMJ.png", Name = "FMJ Vapid", Price = 395000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 196, ImgPath = "/img/Super/formula.png", Name = "Formula One", Price = 1000000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 197, ImgPath = "/img/Super/formula2.png", Name = "Formula Two", Price = 1000000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 198, ImgPath = "/img/Super/Furia.png", Name = "Grotti Furia", Price = 425000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 199, ImgPath = "/img/Super/GP1.png", Name = "GP1 Progen", Price = 200000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 200, ImgPath = "/img/Super/ItaliGTB.png", Name = "Itali GTB Progen", Price = 325000, MSRP = 0, Type = "Super" },
                new Car() { CarId = 201, ImgPath = "/img/Super/Krieger.png", Name = "Benefactor Krieger", Price = 375000, MSRP = 0, Type = "Super" },
